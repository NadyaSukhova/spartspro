...
export function About() {
    ...
    <div class="${styles.about}">
        <h2 class="${styles.header}">О компании</h2>
        ...
        <div class="${styles.info}">
            <h3 class="${styles['main-info']}">Компания «SPARTSPRO» специализируется на поставках лифтового оборудования, комплектующих и запчастей для лифтов и эскалаторов ведущих мировых и российских производителей.</h3>
            ...
            <p>Мы обеспечиваем бесперебойные поставки для ваших проектов. Оставьте заявку – и получите коммерческое предложение в кратчайшие сроки!</p>
                <div class="${styles.more}"><button>Подробнее</button></div>
        </div>
